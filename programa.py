...
while not flg_salir:
    ...
    while flg_menu43:
        ...
        if not opc.isdigit():
            ...
            if opc == 1:
                ...
                opc2, lista, nombre = saber_lista_de_monstruos("Monstruo Enemigos Humanoides", monstruos_enemigos_humanoides)
            elif opc == 4:
                ...
                if not opc_e.isdigit():
                    ...
                    if opc_e == 1:
                        ...
                        while True:
                            ...
                            if not opc_a.isdigit():
                            ...
                            elif not int(opc_a) in range(1, len(eleccion_arma["opciones"]) + 1):
                                print(fuera_rango)
                                input("Enter para continuar")
                                ...
                                if opc_a == len(eleccion_arma["opciones"]):
                                    ...
                                    clave_arma_actual = heroes[keys_heroes[opc - 1]]["arma"]
                                    ...
                                    if armas[clave_arma_actual]["nombre"] == armas[clave_arma_elegida]["nombre"]:
                                        ...
                                        input("Enter para continuar")
                                        heroes[keys_heroes[opc - 1]]["arma"] = clave_arma_elegida
                                        break
    ...
    while flg_edit_arma:
        ...
        elif not int(opc) in range(1, len(eleccion_arma["opciones"]) + 1):
            print(fuera_rango)
            input("Enter para continuar")
